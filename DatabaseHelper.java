...
public class DatabaseHelper {
    ...
    public LogEntry getRow(int index){
    ...
    public void addNewRowToWarrantyMachines(String serviceTag, String machineIssue, String troubleshootingSteps, String partNeeded) {

        try (Statement statement = connection.createStatement()) {
            statement.executeUpdate("INSERT INTO WarrantyMachines (Service_Tag, Machine_Issue, Troubleshooting_Steps, Part_Needed) " +
                    "VALUES (' " + serviceTag + " ' , ' " + machineIssue + " ' , ' "
    ...
    public void addNewRowToWarrantyMachinesBattery(String serviceTag, String machineIssue, String troubleshootingSteps, String partNeeded, String batterySerial) {
        ...
        try (Statement statement = connection.createStatement()) {
            statement.executeUpdate("INSERT INTO WarrantyMachines (Service_Tag, Machine_Issue, Troubleshooting_Steps, Part_Needed, Battery_Serial_Number) " +
                    "VALUES (' " + serviceTag + " ' , ' " + machineIssue + " ' , ' "
                    + troubleshootingSteps + " ' , ' " + partNeeded + " ' , ' " + batterySerial + "');");
